function Search(event) {
    ...
    fetch(BASE_URL + "cerca_utente", { method: "post", body: formdata }).then(onResponse).then(stampa_utenti);
...
function search_tutti(event) {
    ...
    fetch(BASE_URL + "cerca_utenti", { method: "post", body: formdata }).then(onResponse).then(stampa_tutti_utenti);
}
