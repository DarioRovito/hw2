...
//Stampa i post dei follower nella home secondo delle caratterisstiche che vengono definite
function json_post(json) {
    ...
    for (i in contents) {
        ...
        const shelf_prefer = document.createElement('div');
...
function prefer_user(event) {
    event.preventDefault();
    const prefer = event.currentTarget;
