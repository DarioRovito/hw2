...
Route::post('/cerca_utente', 'App\Http\Controllers\SearchPeopleController@cerca_utente');
Route::post('/cerca_utenti', 'App\Http\Controllers\SearchPeopleController@cerca_utenti');
